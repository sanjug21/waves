...
export const NavBar = () => {
  ...
  }, [inputRef, searchResultsRef, profileMenuRef, clearSearch]);
      ...
      <nav className="z-50 p-3 text-white shadow-cyan-800 shadow-lg">
        <div className="mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6 sm:space-x-8 bg-gray-800 bg-opacity-90 backdrop-blur-sm rounded-full py-2 px-4">
            <Link href="/home" className="p-2 rounded-full hover:bg-[rgb(0,12,60)] transition-all duration-200" aria-label="Home" onClick={clearSearch}>
      ...
      {showResultsDropdown && (
        ...
        >
          ...
          {searchResults && searchResults.length > 0 ? (
            ...
            !searchLoading && !searchError && <p className="text-center text-gray-400 py-4">No user found.</p>
          )}
        </div>
      )}
    </>

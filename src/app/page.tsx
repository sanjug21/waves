...
export default function Home() {
  ...
  return (
    <div className="min-h-screen  bg-cover bg-center lendingPage flex flex-col items-center justify-center p-4 overflow-hidden font-sans">
      ...
      <div className="relative bg-opacity-15 backdrop-blur-xl rounded-3xl shadow-xl border border-blue-950 border-opacity-30 p-8 max-w-sm w-full text-center transform transition-all duration-500 ease-out animate-fade-in flex flex-col items-center justify-center bg-black/50">
        {showOptions ? (
